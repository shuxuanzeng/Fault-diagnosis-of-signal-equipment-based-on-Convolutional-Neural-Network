...
if __name__ == '__main__':
    src_data_folder = "C:/Users/Titanic/Desktop/data/fault_photos"   # todo 修改你的原始数据集路径
    target_data_folder = "C:/Users/Titanic/Desktop/data/fault_photos_split"  # todo 修改为你要存放的路径
