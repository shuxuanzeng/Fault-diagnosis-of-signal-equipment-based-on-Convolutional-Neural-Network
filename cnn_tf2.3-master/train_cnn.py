...
# 构建CNN模型
def model_load(IMG_SHAPE=(224, 224, 3), class_num=9):
    # 搭建模型
...
def train(epochs):
    ...
    train_ds, val_ds, class_names = data_load("C:/Users/Titanic/Desktop/data/fault_photos_split/train",
                                              "C:/Users/Titanic/Desktop/data/fault_photos_split/val", 224, 224, 16)
    print(class_names)
    # 加载模型
