...
data_path = "C:/Users/Titanic/Desktop/神经网络/write/MNIST/" # todo 数据集路径
# 注： 执行之前请先划分数据集
# 超参数设置
params = {
    ...
    "img_size": 224,  # 图片输入大小
    "train_dir": osp.join(data_path, "mnist_train"),  # todo 训练集路径
    "val_dir": osp.join(data_path, "mnist_test"),  # todo 验证集路径
    'device': device,  # 设备
    'lr': 1e-3,  # 学习率
    'batch_size': 4,  # 批次大小
    'num_workers': 0,  # 进程
