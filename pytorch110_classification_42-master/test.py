...
data_path = "C:/Users/Titanic/Desktop/神经网络/write/MNIST/"  # todo 修改为数据集根目录
model_path = "C:/Users/Titanic/Desktop/毕业设计/2023_pytorch110_classification_42-master/checkpoints/resnet50d_pretrained_224/resnet50d_10epochs_accuracy0.99457_weights.pth"  # todo 模型地址
...
params = {
    ...
    "test_dir": osp.join(data_path, "mnist_test"),  # todo 测试集子目录
    'device': device,  # 设备
    'batch_size': 4,  # 批次大小
    'num_workers': 0,  # 进程
    "num_classes": len(os.listdir(osp.join(data_path, "mnist_train"))),  # 类别数目, 自适应获取类别数目
}
